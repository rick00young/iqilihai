...
-->
	 ...
	 <div id="right">
            ...
            <div class="table">
            	<form action="__APP__/Notice/noticeSubmit" method="post" enctype="multipart/form-data" >                
            	<table width="780" border="0">
					...
					<tr>
						<td width="200"  align="right">新闻类型:</td>
						<td>
							<select name="type">
								<option value="1">七里海一期</option>
								<option value="2">七里海二期</option>
							</select></td>
						<td width="200"></td>
					</tr>
                    <tr>
						<td width="200"  align="right">公告内容:</td>
						<td><textarea rows="8" cols="55" type="text" name="content"></textarea></td>
						<td width="200"></td>
 <!--
					</tr>                  
                    ...
                    <tr>
						<td width="200"  align="right">图片上传:</td>
						<td><input type="file" name="pic[]"></td>
						<td width="200"></td>
					</tr>
                    <tr>
						<td width="200"  align="right">图片描述:</td>
						<td><input type="text" name="picd" size="65"></td>
						<td width="200"></td>
					</tr>
					-->
                    <tr>
						<td width="200"  align="right"></td>
						<td align="right"><input type="submit" value="提交">&nbsp;&nbsp;&nbsp;<input type="reset" value="重置"></td><td width="200"></td>
					</tr>
                </table>
                </form>
            </div>
