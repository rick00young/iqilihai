            	...
            	<table width="100%" border="1" style="text-align:center;" class="tableUI dataTable">
					...
					<tr>
							...
							<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
									...
									<td>
										<?php if($vo['status'] == 0): ?><a href="__APP__/Notice/notice/Operate/status/<?php echo ($vo['status']); ?>/id/<?php echo ($vo['id']); ?>">发布</a>
										<?php else: ?>
											<a href="__APP__/Notice/noticeOperate/status/<?php echo ($vo['status']); ?>/id/<?php echo ($vo['id']); ?>">停用</a><?php endif; ?>
									</td>
									<td><a href="__APP__/Notice/noticeModify/id/<?php echo ($vo['id']); ?>">修改</a></td>
									<td><a href="__APP__/Notice/noticeDelete/id/<?php echo ($vo['id']); ?>">删除</a></td>
